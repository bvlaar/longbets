...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { details: @bet.details, email: @bet.email, name: @bet.name, reminder: @bet.reminder, sent: @bet.sent }
    end
  ...
  test "should update bet" do
    put :update, id: @bet, bet: { details: @bet.details, email: @bet.email, name: @bet.name, reminder: @bet.reminder, sent: @bet.sent }
    assert_redirected_to bet_path(assigns(:bet))
  end
